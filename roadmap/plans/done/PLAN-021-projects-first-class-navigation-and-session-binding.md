...
- `2026-07-24` — closing to `done/`: projects-as-first-class navigation shipped (PR #90) and is live on `main`; verified in point-release builds. Bookkeeping catch-up (ADR-0002).
