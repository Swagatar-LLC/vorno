...
- `2026-07-24` — closing to `done/`: per-workspace webhooks — host-agnostic ingest, embedded-host parity, and the Automations management UI — are shipped and live on `main`. Bookkeeping catch-up (ADR-0002).
