...
- `2026-07-13` — moved from in-progress to done: merged to main as PR #69, all seven CI gates green. Runtime default feed = github Swagatar-LLC/vorno-releases (repo created same day).
