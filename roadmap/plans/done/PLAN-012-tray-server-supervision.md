...
- `2026-07-24` — closing to `done/`: tray-based server supervision is shipped and live on `main` (feature complete per this plan; packaged-build verification done 2026-07-09). Bookkeeping catch-up — the folder move is the state change (ADR-0002).
