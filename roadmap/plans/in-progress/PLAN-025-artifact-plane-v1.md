...
- `2026-07-24` — **PR #106 merged to main** (head `336b4412`, merge commit `e8b2fa41`, 11:48 EDT) — C1 artifact plane is on main; v0.13.0 candidate. Stays `in-progress`: remaining is runtime QA (G2c), Obsidian-open spot check, and the v0.13.0 cut (Jeff). C2 StorageProvider seam (ADR-0018, PR #114) follows as a separate work stream.
