...
- `2026-07-15` — **v0.12.0 released** (PR #95 → tag v0.12.0 → release run 29437863410 success; latest-mac.yml + dmg/zip + blockmaps verified on vorno-releases). Remaining acceptance: Jeff's real-device phone test of the shipped build.
