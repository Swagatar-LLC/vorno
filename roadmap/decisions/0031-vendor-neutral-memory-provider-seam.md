...
- [PLAN-040 — Integrate Headroom](../plans/planned/PLAN-040-integrate-headroom.md) (§I2, the first non-goal this ADR carves against)
- [SUV-0029 — Memory provider seam with Headroom MCP and built-in markdown providers](../suvs/planned/SUV-0029-memory-provider-seam-with-headroom-and-builtin-markdown-providers.md) (the first slice; re-cut under this ADR)
- [SUV-0040 — Built-in markdown memory provider with decay and temporal processing](../suvs/planned/SUV-0040-builtin-markdown-memory-provider-with-decay-and-temporal-processing.md) (owns the default provider's build-out)
