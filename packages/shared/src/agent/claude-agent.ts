...
// We keep our isKeepBackgroundTasksAliveEnabled() over upstream's resolveKeepBackgroundTasksAlive()
// (see usages below); upstream's new classifyClaudeTaskNotification is additive and adopted.
