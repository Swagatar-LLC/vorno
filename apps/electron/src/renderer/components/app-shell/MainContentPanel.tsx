...
export function MainContentPanel({
  ...
  if (isPagesNavigation(navState)) {
    if (!isNavigatorAvailable('pages', { pagesEnabled, workbenchEnabled: false, artifactsEnabled: false })) {
  ...
  // Workbench navigator - Review Workbench surface (feature-flagged). fork(PLAN-024)
