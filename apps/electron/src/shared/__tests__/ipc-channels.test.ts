...
// The pinned wire format. `scripts/ipc-inventory.ts` used to generate this and
// no longer exists, which is how two additive Pages channels sat unlisted; keep
// it by hand, sorted, until a generator comes back.
//
// A diff here is a question, not a chore. ADDING a line is correct only for a
// genuinely new channel. A line CHANGING or DISAPPEARING means a wire string
// moved — that breaks every already-shipped client and needs an ADR, not an
// edit to this list. Update it in the same commit as the channel, so the list
// records a decision rather than catching up to one.
const EXPECTED_CHANNELS: string[] = [
  ...
  'craft-fork:logging:getState',
  'craft-fork:logging:openLogFolder',
  'craft-fork:logging:revealLogFile',
  'craft-fork:logging:setLevel',
  ...
  'craft-fork:webhooks:upsert',
  'craft-fork:webui:getConfig',
  'craft-fork:webui:getStatus',
  'craft-fork:webui:regeneratePassword',
  'craft-fork:webui:setPassword',
  'craft-fork:webui:start',
  'craft-fork:webui:stop',
  'craft-fork:webui:updateConfig',
  ...
  'sessions:retrieveHeadroomOriginal',
  ...
  'views:list',
  'views:save',
  'vorno:artifacts:index',
  'vorno:artifacts:lifecycle:set',
  'vorno:artifacts:read',
  'vorno:artifacts:relations:list',
  'vorno:artifacts:relations:mutate',
  'vorno:artifacts:roots:list',
  'vorno:artifacts:types:list',
  'vorno:headroom:stats:changed',
  'vorno:headroom:stats:get',
  'vorno:memory:capabilities:get',
  'vorno:workbench:review:artifacts:index',
  'vorno:workbench:review:artifacts:read',
  'vorno:workbench:review:instances:create',
  'vorno:workbench:review:instances:list',
  'vorno:workbench:review:instances:update',
