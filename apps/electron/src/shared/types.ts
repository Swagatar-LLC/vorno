...
export interface ElectronAPI {
  ...
  unpublishPage(workspaceId: string, pageSlug: string): Promise<{ config: import('@craft-agent/shared/pages/types').PageConfig; warning?: 'remote-copy-may-remain' | 'remote-cleanup-pending' }>
