...
- **Host-consented Page actions** — Page capabilities now require approval in a native dialog tied to the requesting workspace window. Approvals are digest-bound, expiring, revocable, and safely serialized when multiple Pages request access. #201, SUV-0059
