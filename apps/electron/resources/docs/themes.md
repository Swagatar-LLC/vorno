...
This guide explains how to customize the visual theme of Vorno.

## Overview

Vorno uses a 6-color theme system with support for both app-level defaults and per-workspace overrides.
